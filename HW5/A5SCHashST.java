...
import algs4.*;
import assignment5.A5LPHashST.Iterator;
 ...
 *  @author Kevin Wayne
 */
public class A5SCHashST<Key, Value> implements Iterable<Key> {
    ...
    private void resize(int chains) {
        A5SCHashST<Key, Value> temp = new A5SCHashST<Key, Value>(chains);
        for (int i = 0; i < m; i++) {
    ...
    public static void main(String[] args) { 
        A5SCHashST<String, Integer> st = new A5SCHashST<String, Integer>();
    ...
    class Iterator implements java.util.Iterator<Key> {
		...
		public Key next() {
			if (hasNext())
				return A5SCHashST.this.keys[current++];
			else
